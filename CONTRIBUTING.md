...
In Github, send a pull request to original master branch: f.e. `terraform-aws-cloudwatch:master`.
...
[github]: https://github.com/philips-software/terraform-aws-cloudwatch/issues
